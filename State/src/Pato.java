...
//Classe com as definições e implementações dos métodos de comportamento do Pato - extendidas de ave
public class Pato extends Ave {
	...
	public void grasnar() {
		comportamentoGrasnar.executador();
	}
